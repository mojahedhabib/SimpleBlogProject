        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="images/avatar.png" class="img-circle" alt="User Image" style="border-radius: 50%;">
                </div>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        <a href="{{route('samplePage')}}">
                            <i class="fa fa-pie-chart"></i>
                            <span>Posts</span></i></span>
                        </a>
                    ...
                    <li class="treeview">
                        <a href="#"><span>User Management</span>
                </span>
                        </a>
